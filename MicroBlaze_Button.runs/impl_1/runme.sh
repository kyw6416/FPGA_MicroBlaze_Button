...
HD_PWD='D:/FPGA/MicroBlaze_Button/MicroBlaze_Button.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlazeButton_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_MicroBlazeButton_wrapper.tcl -notrace
