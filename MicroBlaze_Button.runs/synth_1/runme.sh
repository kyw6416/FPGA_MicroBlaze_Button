...
HD_PWD='D:/FPGA/MicroBlaze_Button/MicroBlaze_Button.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlazeButton_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_MicroBlazeButton_wrapper.tcl
