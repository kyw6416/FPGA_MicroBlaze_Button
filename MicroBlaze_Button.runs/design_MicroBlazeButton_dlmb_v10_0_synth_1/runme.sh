...
HD_PWD='D:/FPGA/MicroBlaze_Button/MicroBlaze_Button.runs/design_MicroBlazeButton_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlazeButton_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_MicroBlazeButton_dlmb_v10_0.tcl
