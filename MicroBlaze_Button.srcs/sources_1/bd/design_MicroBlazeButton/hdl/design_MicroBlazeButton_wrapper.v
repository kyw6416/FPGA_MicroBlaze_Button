...
//Command     : generate_target design_MicroBlazeButton_wrapper.bd
//Design      : design_MicroBlazeButton_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_MicroBlazeButton_wrapper
   (Button_tri_io,
    LED_tri_io,
    reset,
    sys_clock,
  ...
  IOBUF LED_tri_iobuf_7
       (.I(LED_tri_o_7),
        ...
        .O(LED_tri_i_7),
        .T(LED_tri_t_7));
  design_MicroBlazeButton design_MicroBlazeButton_i
